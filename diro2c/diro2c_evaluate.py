...
def main():
    ...
    # datasets_to_test = [dataset_type.credit_approval]

    # datasets_to_test = [dataset_type.adult]

    blackbox_settings = ['LIME_Evaluated_Attribute_Manipulation']

    for bs in blackbox_settings:
        for dt in datasets_to_test:
            ...
            if bs == 'LIME_Evaluated_Attribute_Manipulation':
                if dt is dataset_type.adult:
                    X2 = manipulate_data.manipulate_adult(X)
                elif dt is dataset_type.bank_marketing:
                    X2 = manipulate_data.manipulate_bank_marketing(X)
                elif dt is dataset_type.credit_approval:
                    X2 = manipulate_data.manipulate_credit_approval(X)
            ...
            #     neighbor_generator.get_genetic_neighborhood]
